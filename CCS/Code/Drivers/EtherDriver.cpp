...
void EtherDriver::Init()
{
    ...
    g_pui8MACAddr[5] = 0x05;


	// lwIP Ethernet
	lwIPInit(g_ui32SysClock, g_pui8MACAddr, inet_addr("231.5.168.192"), inet_addr("0.255.255.255"), inet_addr("1.5.168.192"), IPADDR_USE_STATIC); 	// Set IP
	...
	LocatorAppTitleSet("Gimbal3k Board v2");
